 ...
 */
package com.infinity.indianbank;
...
public class validateCredentials extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/mydb", "root", "hello246");
            stmt = con.createStatement();

            //stmt.executeUpdate("insert into student values('" + reg + "','" + name1 + "','" + age + "','" + yr + "','" + dept + "','" + br + "')");

            out.print("<h1>Your account is created successfully!!!</h1>");

        } catch (Exception e) {
            e.printStackTrace();
            out.print("Sorry!! Try again later");
        }
    }
